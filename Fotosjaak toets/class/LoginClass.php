	...
	class LoginClass
	{
		...
		public static function send_activation_email($post_array, $password)
		{
			...
			*/
			...
			$message .= "<a href='http://localhost/blok%202/Fotosjaak/Fotosjaak%20toets/index.php?content=activation&email=".$post_array['email']."&password=".$password."'>activeer account</a><br><br>";
